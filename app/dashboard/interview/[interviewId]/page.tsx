    ...
    return (
        <div className="my-10 ">
                    ...
                    {webCamEnabled ?
                        ...
                        <>
                            ...
                            <Button variant="ghost"
                                onClick={() => setWebCamEnabled(true)}>Enable Webcam and Microphone</Button>
                        </>
                    }
                </div>
            </div>
            <div className='flex justify-end items-end'>
                ...
                <Button className='bg-primary transition-opacity duration-300 hover:bg-primary hover:opacity-80'>Start Interview</Button>
                </Link>
            </div>
